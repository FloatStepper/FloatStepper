...
# Input Parameters
numLines = 8 # Number of mooring lines 
ParaviewStart = 0 # Paraview Visualiasation starting time
ParaviewEnd = 55 # End time of Simulation you needed for Visualisation
dtParaview = 0.25 # Timestep of time folders in the visualisation
