...
figname="wigglingEllipseNxScanPositions.pdf"

#nxlist=["100", "200", "400"]
nxlist=["50", "100", "200"]
scanName='nxMaxCoScan'
#legends = ['100','200','400','Exact']
legends = ['50', '100','200','Exact']
maxCo='0.2'
tmax = 6
...
ax[0].legend(legends,loc='upper center',ncol=4)
