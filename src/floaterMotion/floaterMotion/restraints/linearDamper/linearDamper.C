...
Foam::floaterMotionRestraints::linearDamper::linearDamper
(
    const word& name,
...
void Foam::floaterMotionRestraints::linearDamper::restrain
(
...
bool Foam::floaterMotionRestraints::linearDamper::read
(
    const dictionary& rBMRDict
)
{
...
void Foam::floaterMotionRestraints::linearDamper::write
(
    Ostream& os
) const
{
